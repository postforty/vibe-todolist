# Vibe Todo List Workspace - AGENTS.md

## Overview
This is a full-stack Todo List application consisting of two main parts:
- `backend/`: Python FastAPI backend.
- `frontend/`: React.js + TypeScript frontend using Vite.

## General Instructions
- When working on the backend, change directory to `backend/` and follow the instructions in `backend/AGENTS.md`.
